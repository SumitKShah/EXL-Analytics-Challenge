...
masterdefault$Default.Sum=cut(masterdefault$Default.Sum,breaks=c(-Inf,0,1000,2000,3000,4000,Inf),label=c(0,1,2,3,4,5))
...
(yes$DefaultSum1,breaks=c(-Inf,0,500,900,1300,Inf))
yes$Default1=as.numeric(as.character(yes$Default1))
